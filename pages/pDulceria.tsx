...
export default function pDulceria() {
  return (
    <div className="pb-4">
        ...
        <Header></Header>
        <div>
        <p className="text-center z-10 text-2xl bold text-white pt-4"><span className='text-yellow-400'>CANDYLANDYA</span></p>
        <div className='grid grid-cols-2 gap-8 m-8'>
            ...
            <PCatalogo producto='Piñamitas' imagen="/pinamita.png" page='https://wa.me/5620388381' precio='$300'></PCatalogo>
            <PCatalogo producto='Fruta Enchilada' imagen="/frutaenchilada.png" page='https://wa.me/5620388381' precio='$300'></PCatalogo>
            <PCatalogo producto='Piña Enchilada' imagen="/pinamita.png" page='https://wa.me/5620388381' precio='$300'></PCatalogo>
        ...
        <div className='grid grid-cols-2 gap-8 m-8'>
            <PCatalogo producto='Enchilados' imagen="/arosmanzana.png" page='https://wa.me/5620388381' precio='$500'></PCatalogo>
            <PCatalogo producto='Dulces' imagen="/arosdurazno.png" page='https://wa.me/5620388381' precio='$500'></PCatalogo>
        </div>
        </div>
        </div>
    </div>
