     ...
     <Head>
        ...
        <div className='bg-white p-2 flex flex-col items-center justify-center'>
            ...
            <div className='grid grid-cols-4 gap-2 m-2'>
               ...
               <div className='flex flex-col items-center'>
                  <Image src={data[3].relevantpromo} width={1920} height={1080} alt='promo' className='rounded-xl pb-2'></Image>
                  <Link href="https://byplus.io/beemobile">
                     <BotonPersonalizado texto='BeeMobile' colorF='bg-yellow-400' colorT='text-black'></BotonPersonalizado>
                  </Link>
               </div>
            </div>
        </div>
        ...
        <Link href="https://wa.me/message/FOZGCK245UB7O1">
         ...
         <Link href="https://www.instagram.com/beehigh_mx/">
         <div className='flex flex-col items-center'>
